...
################################
#    CHANGE HERE !!!
start_date = datetime(2025, 12, 1 ) # yyyy, mo, day
...
workday_rotation = ["Yossi", "Gabi", "Gour" ]
weekend_rotation = ["Gour", "Yossi", "Yaron", "Gabi" ]
...
def create_non_overlapping_schedule(workday_rotation, weekend_rotation):
    ...
    weekly_pairs = [
        ...
        ["Gour", "Yossi"],   # Week 2: Gour (2 days), Yossi (3 days)  
        ["Gabi", "Gour"],    # Week 3: Gabi (2 days), Gour (3 days)
    ]
