...
weekend_rotation = ["Dovid", "Yossi", "Gour" ,"Shay", "Tom", "Moriah", "Adiel"]
weekend_rotation_7 = [['Yossi', 'Moriah', 'Tom', 'Shay', 'Adiel', 'Dovid', 'Gour'],
 ['Dovid', 'Gour', 'Moriah', 'Yossi', 'Adiel', 'Shay', 'Tom'],
 ['Tom', 'Dovid', 'Yossi', 'Gour', 'Moriah', 'Adiel', 'Shay'],
 ['Gour', 'Yossi', 'Moriah', 'Tom', 'Shay', 'Dovid', 'Adiel'],
 ['Shay', 'Moriah', 'Adiel', 'Yossi', 'Tom', 'Gour', 'Dovid'],
 ['Adiel', 'Tom', 'Shay', 'Dovid', 'Yossi', 'Moriah', 'Gour'],
 ['Moriah', 'Tom', 'Gour', 'Adiel', 'Dovid', 'Yossi', 'Shay']]
