...
################################
#    CHANGE HERE !!!
start_date = datetime(2026, 7, 1)   # yyyy, mo, day
end_date   = datetime(2026, 7, 31)  # yyyy, mo, day
#
################################
...
#   Week 2: Yossi (Sun,Mon) +  Nadav (Tue,Wed,Thu)
#   Week 3: Yossi (Sun,Mon) +  Gabi  (Tue,Wed,Thu)
#   Week 4: Nadav (Sun,Mon) +  Gabi  (Tue,Wed,Thu)
