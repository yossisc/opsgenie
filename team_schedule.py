...
# Initial setup
# YYYY, M, D
start_date = datetime(2024, 2, 18)  # Start date 7th January 2024
end_date = datetime(2024, 2, 25)  # End date 29th February 2024
team_members = ["Dovid", "Yossi", "Tom", "Moriah", "Adiel"]
#weekend_rotation = ["Tom", "Yaron", "Yossi", None, None]
weekend_rotation = ["Tom", "Adiel", "Yossi", "Dovid", "Moriah"]
first_user = "Dovid"
first_weekend_user = "Adiel"
    ...
    while current_date <= end_date:
        ...
        if day_name == "Friday":
            ...
            if assigned_member == "Moriah" or assigned_member == "Dovid": 
                ...
                schedule.append((current_date.strftime("%d/%m/%Y"), next_day.strftime("%d/%m/%Y"), format_time("2:00PM"), format_time("8:00PM"), "Yaron","WEEKEND"))
